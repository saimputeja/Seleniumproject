 ...
 * 
 * public class S4 { private static WebDriver driver=null; public static void
 * main(String[] args) throws IOException { ExtentHtmlReporter htmlReporter =
 * new ExtentHtmlReporter("extent.html");
 * 
 ...
 * driver.get("https://www.google.co.in/"); String title=driver.getTitle(); //
 * info(details) test.info("This step shows usage of info(details)");
 * 
 * Assert.assertEquals(title,"Google"); // log with snapshot
 * test.fail("details",
